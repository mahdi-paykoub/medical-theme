<?php
$user_save_class = is_user_logged_in() ? 'save-post' : 'save-post-guest';
?>
<span class="cats-save-i border-radios-5 d-flex p-1 cursor-pointer">
                                        <svg width="17" height="17"
                                             class="text-Purple-light <?php echo $user_save_class . ' ';
                                             is_saved( get_the_ID() ) ?>"
                                             fill="none"
                                             viewBox="0 0 10 12" data-postid="<?php echo get_the_ID(); ?>">

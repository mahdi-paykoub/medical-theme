                ...
                <div class="col-12 col-md-8 col-lg-5">
                    <div class="p-login-box bg-white my-4">
                        ...
                        <div class="px-3 px-md-5 mt-4">
                            <button class="w-100 btn bg-Purple-light text-white border-radios-10 py-3 send-login">ورود
                            </button>
                        ...
                        <div class="px-3 px-md-5 mt-3 text-center">
                            <a href="" class="fs15 text-Purple-light">فراموشی رمز عبور</a>
                        </div>


                        <div class="px-3 px-md-5 mt-5 text-center">
                            <span class="text-dark fs16">هنوز ثبت نام نکردی؟</span>
                        </div>
                        <div class="px-3 px-md-5 mt-3">
                            <a href="<?php echo home_url() . '/index.php/register'; ?>"
                               class="w-100 btn bg-orange-dark text-white border-radios-10 py-3">ثبت نام</a>
                        </div>
